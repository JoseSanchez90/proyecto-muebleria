...
function Decoracion() {
  ...
  // Cargar productos de la categoría Decoración
  useEffect(() => {
      ...
      <div className="min-h-screen bg-gray-100 py-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-gray-600">Cargando decoración...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12">
      <div className="container mx-auto px-4">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Decoración</h1>
          <p className="text-gray-600">
            Elementos decorativos para darle personalidad a tus espacios
          </p>
        </div>
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-lg">
            <p className="text-gray-500 text-lg">No se encontró decoración</p>
              ...
              >
                ...
                >
                  ...
                  <button
                    ...
                    disabled={isToggling}
                    className="absolute top-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors disabled:opacity-50"
                  >
                    <Heart
                      className={`w-4 h-4 ${
