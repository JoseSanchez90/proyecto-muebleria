...
function NavbarMobile() {
  ...
  return (
    <>
      <section className="flex lg:hidden w-full bg-white shadow-sm border-b border-gray-200 fixed top-0 left-0 right-0 z-50">
        <div className="w-full px-4 py-3">
          ...
          {searchOpen && (
            <div
              ref={searchRef}
              className="mt-3 animate-in fade-in duration-200"
            >
